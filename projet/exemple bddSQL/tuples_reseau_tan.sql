...
INSERT INTO RESEAUTAN (ligne_id, ligne_nom, ligne_type, arret_id, arret_nom, vehicule_id, vehicule_type, capacite, carburant, accessibilité) VALUES
--ligne_id  ligne_nom              ligne_type   arret_id    arret_nom     vehicule_id  vehicule_type   capacite  carburant  accessibilité
    ...
    (7,     'N2',                 'Fluviales',    8,       'Île de Nantes',      303,   'Navibus',      95,    'Électrique',    'Rampe d’accès'),
